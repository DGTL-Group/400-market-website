...
// ISR: each event detail page is prerendered at build time via
// generateStaticParams below, then refreshed at most once per hour. The
// Events collection's afterChange hook also calls revalidatePath() for
// the specific slug, so admin edits show up instantly without waiting.
