...
const styleBlock = `  <style>
    ...
    rect {
      ...
      stroke-width: 1;
      vector-effect: non-scaling-stroke;
      /* Transition stroke only — animating fill here was causing
         Chrome to pin the computed fill at the start value when the
         page-level mode class flipped the cascade target, leaving
         become-a-vendor available booths stuck on white. */
    ...
    /* Merged adjacent-booth shape — a polygon path tracing the
       cluster's outer perimeter (handles L/T/U-shapes). Slightly
       thicker stroke so it reads as one unit, no internal borders
       between the cluster's component booths. */
    path[data-fp-merged],
    rect[data-fp-merged] {
      fill: #F7D117;
      stroke: #2C2C2C;
